...
operations = {'ADD':add , 'ADDITION':add , 'SUM':add , 'PLUS':add , '+':add,
                'SUB':sub , 'DIFFERENCE':sub , 'MINUS':sub , 'SUBTRACT':sub,'-':sub,
                 ...
                 'MULTIPLY':mul , 'DIVISION':div , 'DIV':div ,'DIVIDE':div,'/':div, 'MOD':mod ,
...
l1 = Label(win , text='I am a smart calculator',width=20 , padx=3 , bg='powderblue')
l1.place(x=152,y=10)
l2 = Label(win , text='My name is Papu' , padx=3 , bg='powderblue')
l2.place(x=180,y=40)
l3 = Label(win , text='How can i help you' , padx=3 , bg='powderblue')
l3.place(x=173,y=121.5)

textin = StringVar()
e1 = Entry(win , width=40 , textvariable = textin)
e1.place(x=110,y=150)

b1 = Button(win , text='Just this' ,command=calculate , bg='powderblue')
b1.place(x=292,y=174)

list = Listbox(win,width=30,height=3)
list.place(x=142,y=230)
